...
oneMb.df <- fread(work.dir2 %&% "all_sigGenes_apayne_291117_anno.txt")
...
413 significant gene-metabolite pairs are within 1Mb of significant metQTLs, likely to be bystanders 
372 significant gene-metabolite pairs are not bystander associations and 
    do not involve predicted causal genes for the metabolite 

121 pairs are outside of 1Mb windows, not predicted causal for the metabolite, and are in hmdb; 
    corresponding to 105 unique genes 
Therefore, upwards of 32.5% (121/371) of novel genes-metabolite are biologically plausible 
...
filt.df %>% dim(.) # 121
121/372 # 0.3252688
filt.df$gene_name %>% unique(.) %>% length(.) # 105 genes 
...
Of the 372 pairs that do not involve a predicted causal gene and are not bystander genes wrt the metabolite, 
...
Therefore, upwards of 3.2% (12/372) of novel genes-metabolite are biologically plausible, lower range  
